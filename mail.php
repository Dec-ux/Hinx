...
if ($name == "") {
    ...
    $headers .= 'From:  Papr <david-mern@outlook.com>' . "\r\n";
    $headers .= 'cc: david-mern@outlook.com' . "\r\n";
    $headers .= 'bcc: david-mern@outlook.com' . "\r\n";
    mail($to, $subject, $_message, $headers, '-f david-mern@outlook.com');
